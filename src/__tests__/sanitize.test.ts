 ...
 *
 * Ported from the skills repo (`tests/sanitize-terminal.test.ts`).
 *
 ...
 *
 * Note: `sanitizeName` tests from the skills repo were skipped because
 * skill-packer's sanitize.ts does not export that function.
 */
